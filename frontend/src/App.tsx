        ...
        <BrowserRouter>
          <Routes>
            ...
            <Route element={<Protected />}>
              ...
              <Route
                path="/retail/controlled-drugs"
                element={forPharmacy(<ControlledSubstancesPage />)}
              />
              <Route path="/retail/promotions" element={forPharmacy(<PromotionsPage />)} />
              <Route
                path="/retail/clinical-services"
                element={forPharmacy(<ClinicalServicesPage />)}
              />
              ...
              <Route
                path="/catalog/interactions"
                element={<Navigate to="/catalog/manufacturers?tab=interactions" replace />}
              />
              <Route
                path="/catalog/uom"
                element={<Navigate to="/catalog/manufacturers?tab=uom" replace />}
              />
              <Route
                path="/catalog/substitutes"
                element={<Navigate to="/catalog/manufacturers?tab=substitutes" replace />}
              />
              <Route
                path="/catalog/manufacturers"
                element={forPharmacy(<ReferenceDataWorkspace />)}
              />
              <Route
                path="/catalog/ingredients"
                element={<Navigate to="/catalog/manufacturers?tab=ingredients" replace />}
              />
              <Route path="/inventory" element={forPharmacy(<InventoryHome />)} />
              <Route
                path="/inventory/warehouses"
                element={forPharmacy(<WarehouseSetupWorkspace />)}
              />
              <Route
                path="/inventory/zones"
                element={<Navigate to="/inventory/warehouses?tab=zones" replace />}
              />
              <Route
                path="/inventory/putaway"
                element={<Navigate to="/inventory/warehouses?tab=putaway" replace />}
              />
              ...
              <Route
                path="/inventory/temperature"
                element={<Navigate to="/inventory/coldchain?tab=logs" replace />}
              />
              ...
              <Route
                ...
                element={forPharmacy(<OrderWorkbenchPage />)}
              />
              ...
              <Route
                path="/distribution/tenders"
                element={forPharmacy(<InstitutionalTendersPage />)}
              />
              ...
              <Route
                ...
                element={forProcurement(<RequisitionsPage />)}
              />
              <Route
                path="/procurement/requisitions/:id"
                element={forProcurement(<RequisitionWorkbenchPage />)}
              />
              ...
              <Route
                ...
                element={forProcurement(<GrnWorkbenchPage />)}
              />
              <Route
                path="/procurement/invoices"
                element={forProcurement(<SupplierInvoicesPage />)}
              />
              <Route
                path="/procurement/suppliers"
                element={forProcurement(<SupplierMasterPage />)}
              />
              <Route
                path="/procurement/suppliers/:id"
                element={forProcurement(<SupplierWorkbenchPage />)}
              />
              ...
              <Route
                path="/permissions"
                element={<Navigate to="/users?tab=permissions" replace />}
              />
              ...
              <Route
                path="/finance/credit"
                element={<Navigate to="/finance/receivables?tab=credit" replace />}
              />
              ...
              <Route
                ...
                element={<Navigate to="/finance/receivables?tab=dunning" replace />}
              />
              <Route
                path="/finance/statement"
                element={<Navigate to="/finance/receivables?tab=statements" replace />}
              />
              <Route path="/finance/banking" element={forFinance(<CashBankWorkspace />)} />
              <Route
                path="/finance/reconciliation"
                element={<Navigate to="/finance/banking?tab=reconciliation" replace />}
              />
              ...
              <Route
                path="/finance/tax-ebm"
                element={<Navigate to="/finance/tax?tab=ebm" replace />}
              />
              <Route path="/finance/tax" element={forFinance(<TaxWorkspace />)} />
              <Route
                path="/finance/tax/payments"
                element={<Navigate to="/finance/tax?tab=payments" replace />}
              />
              ...
              <Route
                ...
                element={<Navigate to="/finance/tax?tab=codes" replace />}
              />
              ...
              <Route
                path="/people/roster"
                element={<Navigate to="/people/attendance?tab=roster" replace />}
              />
              <Route path="/people/leave" element={forHR(<LeavePage />)} />
              <Route
                path="/people/timesheets"
                element={<Navigate to="/people/attendance?tab=timesheets" replace />}
              />
              ...
              <Route
                path="/people/statutory-rates"
                element={<Navigate to="/people/filings?tab=rates" replace />}
              />
