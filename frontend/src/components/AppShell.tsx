...
const NAV: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/quality", label: "Quality & CAPA", icon: ShieldAlert },
      { to: "/quality/audits", label: "Internal audit", icon: ClipboardCheck },
      { to: "/service-desk", label: "Service desk", icon: LifeBuoy },
